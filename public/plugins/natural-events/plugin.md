...
User writes `?` with an arrow. Produce one `html_widget` at the arrow destination listing recent open volcano events, dates, coordinates, and NASA EONET attribution.
