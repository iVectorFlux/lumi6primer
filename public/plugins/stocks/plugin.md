...
User writes ` ` and points right. Use `sh600519` and produce one `html_widget` showing quote, change, 60 daily periods, volume, key valuation fields, source, and update time.
