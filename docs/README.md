...
These files are for the team. Do not publish them, and do not copy them into a public README.
...
| [todo.md](./todo.md) | Working list: Thinking Mode design, interactives migration |

Operators only need the root [README](../README.md) and `GO-LIVE.md`.
